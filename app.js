...
async function signedAudioUrl(trackId,signal){
  if(typeof trackId!=='string'||!(/^[a-z0-9]+(?:-[a-z0-9]+)*$/).test(trackId))throw Error('Identifiant audio invalide.');
